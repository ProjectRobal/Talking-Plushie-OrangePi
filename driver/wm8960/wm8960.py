...
_RADC = 0x16
_ADDCTL1 = 0x17
# Register _ADDCTL2 = 0x18
_POWER1 = 0x19
_POWER2 = 0x1A
_ADDCTL3 = 0x1B
# Register _APOP1 = 0x1C
# Register _APOP2 = 0x1D
_LINPATH = 0x20
_RINPATH = 0x21
_LOUTMIX = 0x22
_ROUTMIX = 0x25
...
# WM8960 CLOCK2 bits
_CLOCK2_BCLK_DIV_MASK = 0x0F
_CLOCK2_DCLK_DIV_MASK = 0x1C0
_CLOCK2_DCLK_DIV_SHIFT = 0x06

# Register _IFACE1
_IFACE1_FORMAT_MASK = 0x03
_IFACE1_WL_MASK = 0x0C
_IFACE1_WL_SHIFT = 0x02
_IFACE1_LRP_MASK = 0x10
_IFACE1_MS_MASK = 0x40
_IFACE1_DLRSWAP_MASK = 0x20
_IFACE1_ALRSWAP_MASK = 0x100

# Register _POWER1
_POWER1_VREF_MASK = 0x40
_POWER1_VREF_SHIFT = 0x06
_POWER1_AINL_MASK = 0x20
_POWER1_AINR_MASK = 0x10
_POWER1_ADCL_MASK = 0x08
_POWER1_ADCR_MASK = 0x0
_POWER1_MICB_MASK = 0x02
_POWER1_MICB_SHIFT = 0x01

# Register _POWER2
_POWER2_DACL_MASK = 0x100
_POWER2_DACR_MASK = 0x80
_POWER2_LOUT1_MASK = 0x40
_POWER2_ROUT1_MASK = 0x20
_POWER2_SPKL_MASK = 0x10
_POWER2_SPKR_MASK = 0x08
_POWER3_LMIC_MASK = 0x20
_POWER3_RMIC_MASK = 0x10
_POWER3_LOMIX_MASK = 0x08
_POWER3_ROMIX_MASK = 0x04

# Register _DACCTL1 .. 3
_DACCTL1_MONOMIX_MASK = 0x10
_DACCTL1_MONOMIX_SHIFT = 0x4
_DACCTL1_DACMU_MASK = 0x08
_DACCTL1_DEEM_MASK = 0x06
_DACCTL1_DEEM_SHIFT = 0x01
_DACCTL2_DACSMM_MASK = 0x08
_DACCTL2_DACMR_MASK = 0x04
_DACCTL3_ALCSR_MASK = 0x07

# _WM8060_ALC1 .. 3
_ALC_CHANNEL_MASK = 0x180
_ALC_CHANNEL_SHIFT = 0x7
_ALC_MODE_MASK = 0x100
_ALC_MODE_SHIFT = 0x8
_ALC_GAIN_MASK = 0x70
_ALC_GAIN_SHIFT = 0x4
_ALC_TARGET_MASK = 0x0F
_ALC_ATTACK_MASK = 0x0F
_ALC_DECAY_MASK = 0xF0
_ALC_DECAY_SHIFT = 4
_ALC_HOLD_MASK = 0xF

# Register _NOISEG
_NOISEG_LEVEL_SHIFT = 3

_I2C_ADDR = 0x1A

# WM8960 maximum volume values
_MAX_VOLUME_ADC = 0xFF
_MAX_VOLUME_DAC = 0xFF
_MAX_VOLUME_HEADPHONE = 0x7F
_MAX_VOLUME_LINEIN = 0x3F
_MAX_VOLUME_SPEAKER = 0x7F

# Config symbol names
# Modules
MODULE_ADC = 0  # ADC module in WM8960
MODULE_DAC = 1  # DAC module in WM8960
MODULE_VREF = 2  # VREF module
MODULE_HEADPHONE = 3  # Headphone
MODULE_MIC_BIAS = 4  # Mic bias
MODULE_MIC = 5  # Input Mic
MODULE_LINE_IN = 6  # Analog in PGA
MODULE_LINE_OUT = 7  # Line out module
MODULE_SPEAKER = 8  # Speaker module
MODULE_OMIX = 9  # Output mixer
MODULE_MONO_OUT = 10  # Mono mix

# Route
ROUTE_BYPASS = 0  # LINEIN->Headphone.
ROUTE_PLAYBACK = 1  #  I2SIN->DAC->Headphone.
ROUTE_PLAYBACK_RECORD = 2  # I2SIN->DAC->Headphone, LINEIN->ADC->I2SOUT.
ROUTE_RECORD = 5  # LINEIN->ADC->I2SOUT.

# Input
INPUT_CLOSED = 0  # Input device is closed
INPUT_MIC1 = 1  # Input as single ended mic, only use L/RINPUT1
INPUT_MIC2 = 2  # Input as diff. mic, use L/RINPUT1 and L/RINPUT2
INPUT_MIC3 = 3  # Input as diff. mic, use L/RINPUT1 and L/RINPUT3
INPUT_LINE2 = 4  # Input as line input, only use L/RINPUT2
INPUT_LINE3 = 5  # Input as line input, only use L/RINPUT3

# ADC sync input
SYNC_ADC = 0  # Use ADCLRC pin for ADC sync
SYNC_DAC = 1  # used DACLRC pin for ADC sync

# Protocol type
BUS_I2S = 2  # I2S type
BUS_LEFT_JUSTIFIED = 1  # Left justified mode
BUS_RIGHT_JUSTIFIED = 0  # Right justified mode
BUS_PCMA = 3  # PCM A mode
BUS_PCMB = 3 | 1 << 4  # PCM B mode
...
ALC_STEREO = 3
ALC_MODE = 0  # ALC mode
ALC_LIMITER = 1  # Limiter mode

# Clock Source
SYSCLK_MCLK = 0  # sysclk source from external MCLK
SYSCLK_PLL = 1  # sysclk source from internal PLL
...
class Regs:
    ...
    def __setitem__(self, reg, value):
        if type(reg) is tuple:
            ...
            write = i2c_msg.write(self.i2c_address,self.value_buffer)
